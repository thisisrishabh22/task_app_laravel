...
<body class="antialiased">
    <div
        ...
        @if (Route::has('login'))
            <div
                class="sm:fixed sm:top-0 sm:right-0 p-6 text-right bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 w-full">

                <div class="flex justify-between">
                    <div class="flex w-min">
                        <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-8">
                            <path
        ...
        <div class="max-w-7xl mt-20 mx-auto p-6 lg:p-8">
            ...
            <div class="flex flex-col-reverse md:flex-row justify-evenly items-center">
                <div class="flex flex-col justify-between items-start">
                    ...
                    <p class="text-gray-700 dark:text-gray-300 text-lg my-12">
                        Task App is the #1 software for project management, according to everyone out there. See all
            ...
            <div class="flex flex-col justify-evenly items-center mt-12">
                <div class="text-center">
                    <h2 class="text-gray-900 dark:text-gray-100 text-3xl my-2 font-extralight">Why Task App?</h2>
                    <p class="text-gray-700 dark:text-gray-300 text-lg my-8">Task App increases employee productivity
                        and
            ...
            <div class="flex justify-center items-center mt-16 px-0">

                <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    Developed by <a class="text-indigo-400 underline" href="https://geeekgod.ml" rel="noreferer">Rishabh
                        Singh</a>
                </div>
            </div>
        </div>
